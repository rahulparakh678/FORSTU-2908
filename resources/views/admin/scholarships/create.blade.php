...
<div class="card">
    ...
    <div class="card-body">
        {{--
            ...
            <label>Logo of organization</label>
            <form action="{{route('logoup')}} " method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}

            <input type="file" name="scholarship_logo">
        ...
        <form method="POST" action="{{ route("admin.scholarships.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 " name="courses[]" id="courses" multiple required>
            ...
            <div class="form-group">
                <label for="scholarship_amount">{{ trans('cruds.scholarship.fields.scholarship_amount') }} Per Student</label>
            ...
            <div class="form-group">
                <label class="required">Application Link</label>
                
                <input type="text" name="application_link" class="form-control">
            </div>
            <div class="form-group">
