...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.scholarshipAchiever.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.scholarship-achievers.update", [$scholarshipAchiever->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="student_name">{{ trans('cruds.scholarshipAchiever.fields.student_name') }}</label>
                <input class="form-control {{ $errors->has('student_name') ? 'is-invalid' : '' }}" type="text" name="student_name" id="student_name" value="{{ old('student_name', $scholarshipAchiever->student_name) }}" readonly="">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('collegename') ? 'is-invalid' : '' }}" type="text" name="collegename" id="collegename" value="{{ old('collegename', $scholarshipAchiever->collegename) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('course') ? 'is-invalid' : '' }}" type="text" name="course" id="course" value="{{ old('course', $scholarshipAchiever->course) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('students_city') ? 'is-invalid' : '' }}" type="text" name="students_city" id="students_city" value="{{ old('students_city', $scholarshipAchiever->students_city) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('schemename') ? 'is-invalid' : '' }}" name="schemename" id="schemename">{!! old('schemename', $scholarshipAchiever->schemename) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('scholarshipamount') ? 'is-invalid' : '' }}" type="number" name="scholarshipamount" id="scholarshipamount" value="{{ old('scholarshipamount', $scholarshipAchiever->scholarshipamount) }}" step="1">
