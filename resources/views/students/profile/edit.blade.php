...
<div id="accordion">
        ...
        <div id="collapseOne" class="collapse" data-parent="#accordion">
            <div class="card-body">
                ...
                <label class="required">Are You Orphan ?
                    ...
                    @foreach(App\StudentProfile::HANDICAPPED_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('orphan') ? 'is-invalid' : '' }}">
                            <input class="form-check-input orphan" type="radio" id="orphan_{{ $key }}" name="orphan" value="{{ $key }}" {{ old('handicapped',$profile->orphan) === (string) $key ? 'checked' : '' }} required>
                ...
                <div class="form-group" >
                    ...
                    <small><strong>Please select Yes if anyone from your parent(Mother/Father) is not alive</strong></small>
                    @foreach(App\StudentProfile::SINGLE_PARENT_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('single_parent') ? 'is-invalid' : '' }}">
                            <input class="form-check-input singleparent" type="radio" required id="single_parent_{{ $key }}" name="single_parent" value="{{ $key }}" {{ old('single_parent',$profile->single_parent) === (string) $key ? 'checked' : '' }}>
    ...
    <div class="card" id="class12_details" >
        ...
        <div id="collapseSeven" class="collapse"  data-parent="#accordion">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('previous_marks_total') ? 'is-invalid' : '' }}" type="text" name="cgpa_class_12_marks_total" id="cgpa_class_12_marks_total"   style="display: none;" step="0.01" min="0" max="10" >
                @if($errors->has('cgpa_previous_marks_total'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cgpa_previous_marks_total') }}
                    </div>
    ...
    <div class="card" id="student_documents">
        ...
        <div id="collapseTen" class="collapse" data-parent="#accordion">
            ...
            <hr>
                    ...
                    <td id="aadhar_document">
                        ...
                        <button class="btn btn-success"  value=" " id="aadhar_doc">Attach Later </button>    
                    </td>
                    @else
                    <td>
            ...
            <td id="add_document">
                ...
                <button class="btn btn-success"  value=" " id="add_doc">Attach Later </button>
            </td>
            @else
            <td>
        ...
        <tr>
            ...
            <td id="phy_document">
                ...
                <button class="btn btn-success"  value=" " id="phy_doc">Attach Later </button>
        ...
        <tr>
            ...
            <td id="single_document">
                ...
                <button class="btn btn-success"  value=" " id="single_doc">Attach Later </button>
            </td>
            @else
            <td>
        ...
        <tr>
            ...
            <td id="income_document">
                ...
                <button class="btn btn-success"  value=" " id="income_doc">Attach Later </button> 
            </td>
            @else
            <td>
        ...
        <tr>
            ...
            <td id="bank_document">
                ...
                <button class="btn btn-success" type="submit" value="Upload">Upload </button>
                 ...
                 <button class="btn btn-success"  value=" " id="bank_doc">Attach Later </button> 
            </td>
            @else
            <td>
        ...
        <tr>
            ...
            <td id="fees_document">
                ...
                <button class="btn btn-success"  value=" " id="fees_doc">Attach Later </button>    
        ...
        <tr>
            ...
            @if($profile->hostel_reciept===null)
            
            <td id="hostel_document">
                ...
                <button class="btn btn-success"  value=" " id="hostel_doc">Attach Later </button>     

            </td>
            @else
            <td>
                <a href="{{$profile->hostel_reciept}} " style="text-decoration: none;" target="_blank" class="btn btn-primary">View</a> 
                <button type="button" class="btn btn-danger btn-md" data-toggle="modal" data-target="#hfees">Delete</button>
        ...
        <tr>
            ...
            <td id="class10_document">
                ...
                <button class="btn btn-success"  value=" " id="class10_doc">Attach Later </button>     
        ...
        @endif
        @if(($profile->course_type_id != '1') && ($profile->course_type_id != '2'))
        <tr>
            ...
            <td id="class12_document">
                ...
                <button class="btn btn-success"  value=" " id="class12_doc">Attach Later </button> 
            </td>
            @else
            <td>
        ...
        @endif
        @if(($profile->course_type_id == '4') || ($profile->course_type_id == '5'))
        <tr>
            ...
            <td id="diploma_document">
                ...
                <button class="btn btn-success"  value=" " id="diploma_doc">Attach Later </button>      
        ...
        <tr>
            ...
            <td id="pg_document">
                ...
                <button class="btn btn-success"  value=" " id="pg_doc">Attach Later </button>     
        ...
        <tr>
            ...
            <td id="previous_document">
                ...
                <button class="btn btn-success"  value=" " id="previous_doc">Attach Later </button>     
            ...
            @if($profile->paid_interest == null && $profile->loan_interest==null)
            <div class="form-group ">
