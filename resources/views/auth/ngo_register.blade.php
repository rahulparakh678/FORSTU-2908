        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <img src="{{asset('external/img/united.png')}}" alt="" height="70"></a>
                {{ __('Register') }} & Recieve Free Scholarship Update According to Your Course</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="ULF2020" readonly  autofocus>
                            </div>
                        </div>
