                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course" required>
                                    ...
                                    <option value="Smt.Hiraben Nanavati Institute of Management & Research">Smt.Hiraben Nanavati Institute of Management & Research</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="HNIMR" readonly autofocus>
                            </div>
                        </div>
