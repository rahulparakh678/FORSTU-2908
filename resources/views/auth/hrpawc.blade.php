            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label  class="col-md-4 col-form-label text-md-right">College Name</label>

                            <div class="col-md-6">
                                <input id="inst_name" type="text" class="form-control"   value="H.R Arts Patel Womens College" readonly autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="HRPAWC" readonly autofocus>
                            </div>
                        </div>
