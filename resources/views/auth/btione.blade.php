                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course" required>
                                    <option value disabled="" selected>Please Select College</option>
                                    <option value="Smt Bakul Tambat Institute of Nursing">Smt Bakul Tambit Institute of Nursing</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="course" id="course" required>
                                    ...
                                    <option value="A.N.M">A.N.M Nursing</option>
                                    <option value="G.N.M">G.N.M Nursing</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="BTIONE" readonly autofocus>
                            </div>
                        </div>
