                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course">
                                    ...
                                    <option value="Cummins College of Engineering for Womens">Cummins College of Engineering for Womens</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="course" id="course" required>
                                    ...
                                    <option value="B.E/B.Tech">M.Tech</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="CUMMINS" readonly autofocus>
                            </div>
                        </div>
