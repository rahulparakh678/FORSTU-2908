                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course">
                                    ...
                                    <option value="Trinity College of Engineering">Trinity College of Engineering</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="course" id="course">
                                    ...
                                    <option value="Trinity College of Engineering">B.E/B.Tech</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="caste" id="caste">
                                    ...
                                    <option value="Class 1-10">Open</option>
                                    <option value="Class 1-10">OBC</option>
                                    <option value="Class 1-10">SC</option>
                                    <option value="Class 1-10">ST</option>
                                    <option value="Class 1-10">NT</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="ADCET" readonly autofocus>
                            </div>
                        </div>
