                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course" required>
                                    ...
                                    <option value="Dr.Bhanuben Nanavati College of Architecture for Women">Dr.Bhanuben Nanavati College of Architecture for Women</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="course" id="course" required>
                                    ...
                                    <option value="C.A.I.D">C.A.I.D</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="BNCOA" readonly autofocus>
                            </div>
                        </div>
