                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="college" id="course">
                                    ...
                                    <option value="Kusumtai Rajarambapu patil college, Islampur(KRP)">kusumtai Rajarambapu patil college, Islampur(KRP)</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="course" id="course">
                                    ...
                                    <option value="B.Sc">B.C.A</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ref_code" type="text" class="form-control"  name="ref_code" value="KRPKANYA" readonly autofocus>
                            </div>
                        </div>
